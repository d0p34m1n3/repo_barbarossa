...
namespace workbook
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            DateTime now = EasterSunday(2000);
            Console.WriteLine(now.ToString("yyyyMMdd"));
            List<DateTime> holidayList = GetBusinessDays(new DateTime(2014,1,1).Date, new DateTime(2014,2,2).Date);
            //HashSet<DateTime> holidayList2 = holidayList;
        }

        private static List<DateTime> GetBusinessDays(DateTime dateFrom, DateTime dateTo)

        {
            ...
            businessDays.Sort((a,b)=>b.CompareTo(a));
            return businessDays;
